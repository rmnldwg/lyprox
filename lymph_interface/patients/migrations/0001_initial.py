# Generated by Django 3.1.6 on 2021-03-24 09:44
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('location', models.PositiveSmallIntegerField(choices=[(0, 'oral cavity'), (1, 'oropharynx'), (2, 'hypopharynx'), (3, 'larynx')], null=True)),
