    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_staff', models.BooleanField(default=False, help_text='Decides whether a user can log into the admin site', verbose_name='staff status')),
                ('is_active', models.BooleanField(default=False, help_text='Indicates account status. Should be deactivated instead of deleting the account.', verbose_name='active')),
                ...
                ('institution', models.ForeignKey(blank=True, null=True, on_delete=models.deletion.CASCADE, to='accounts.institution')),
