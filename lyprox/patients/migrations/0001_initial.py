    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('institution', models.ForeignKey(on_delete=models.deletion.CASCADE, to='accounts.institution')),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dataset', models.ForeignKey(on_delete=models.deletion.CASCADE, to='patients.dataset')),
            ],
            bases=(patients.mixins.LockedDatasetMixin, loggers.ModelLoggerMixin, models.Model),
        ),
        migrations.CreateModel(
            name='Tumor',
            fields=[
