    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('csv_file', models.FileField(upload_to=patients.models.get_filepath, validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['csv'])])),
                ('md5_hash', models.BinaryField(unique=True)),
                ('is_hidden', models.BooleanField(default=True)),
                ('repo_provider', models.CharField(blank=True, max_length=128, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dataset', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='patients.dataset')),
            ],
            bases=(core.loggers.ModelLoggerMixin, models.Model),
        ),
        migrations.CreateModel(
