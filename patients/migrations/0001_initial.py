    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('upload_csv', models.FileField(blank=True, null=True, upload_to=patients.models.get_upload_filepath, validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['csv'])])),
                ('export_csv', models.FileField(blank=True, null=True, upload_to='', validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['csv'])])),
