    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('csv_file', models.FileField(null=True, upload_to=patients.models.get_filepath, validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['csv'])])),
                ('md5_hash', models.BinaryField(null=True, unique=True)),
