...
urlpatterns = [
    ...
    path("dataset/upload", views.CreateDatasetView.as_view(), name="dataset_upload"),
    # path("dataset/create", views.CreateDatasetView.as_view(), name="dataset_create"),
    path("dataset/", views.DatasetListView.as_view(), name="dataset_list"),
    path("dataset/download/<path:relative_path>", views.DatasetView.as_view(), name="dataset_download"),
]
