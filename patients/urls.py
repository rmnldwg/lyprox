...
urlpatterns = [
    ...
    path("upload/", views.CreateDatasetView.as_view(), name="upload"),
    path("download/", views.DatasetListView.as_view(), name="download"),
    path("download/<path:relative_path>", views.DatasetView.as_view(), name="table_download"),
